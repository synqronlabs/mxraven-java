...
public enum WebhookEventType {
    ...
    /**
     * Resolves the event type for its wire value.
     *
     * @param value the wire value
     * @return the matching event type, or {@code null} when {@code value} is {@code null}
     * @throws IllegalArgumentException when no event type matches the value
     */
    @JsonCreator
