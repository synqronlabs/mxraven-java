...
/**
 * Request body for <code>POST /v2/tenants/{slug}/identity-providers/gitlab</code>.
 */
@JsonAutoDetect(fieldVisibility = JsonAutoDetect.Visibility.ANY)
public final class CreateTenantGitLabIdentityProviderRequest {
    ...
    public boolean equals(Object o) {
        ...
        CreateTenantGitLabIdentityProviderRequest that = (CreateTenantGitLabIdentityProviderRequest) o;
    ...
    public String toString() {
        return "CreateTenantGitLabIdentityProviderRequest[" + "idpRef=" + this.idpRef + ", " + "name=" + this.name + ", " + "clientId=" + this.clientId + ", " + "clientSecret=" + this.clientSecret + ", " + "scopes=" + this.scopes + ", " + "providerOptions=" + this.providerOptions + "]";
    }

    /**
     * Creates a new CreateTenantGitLabIdentityProviderRequest.
     *
     ...
     */
    @JsonCreator
    public CreateTenantGitLabIdentityProviderRequest(String idpRef, String name, String clientId, String clientSecret, List<String> scopes, ProviderOptions providerOptions) {
        this.idpRef = idpRef;
        this.name = name;
    ...
    /** Builds a {@link CreateTenantGitLabIdentityProviderRequest}. */
    public static final class Builder {
         ...
         */
        public CreateTenantGitLabIdentityProviderRequest build() {
            ...
            return new CreateTenantGitLabIdentityProviderRequest(idpRef, name, clientId, clientSecret, scopes, providerOptions);
        }
    }
}
